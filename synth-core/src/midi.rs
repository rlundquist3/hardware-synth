...
mod tests {
    ...
    use crate::midi::{MidiMessage, get_linear_bent_freq, get_pitch_bend_value};
    ...
    #[test]
    fn no_bend() {
        assert_eq!(get_linear_bent_freq(60, 8192, 2), 261.626);
    }
    #[test]
    fn partial_bend_up() {
        assert_eq!(get_linear_bent_freq(60, 12472, 2), 278.3672);
    }
    #[test]
    fn partial_bend_down() {
        assert_eq!(get_linear_bent_freq(60, 2356, 2), 241.29118);
    }
}
